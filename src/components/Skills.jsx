          ...
          <div className="grid lg:grid-cols-4 grid-cols-2 lg:gap-8 gap-4">
            {data.map((dat) => (
              ...
              >
                <img
                  src={dat.icon}
                  className="w-12 h-14 bg-cover group-hover:scale-110 duration-300"
                  alt=""
                />
                <h2 className="uppercase lg:text-md text-[9px] py-1 font-semibold mt-2 border border-[#36bdf8] text-[#36bdf8] px-4 rounded-full">
                  {dat.name}
                </h2>
                <h2 className="uppercase lg:text-md text-[9px] py-1 font-semibold mt-2 border border-[#36bdf8] text-[#36bdf8] px-4 rounded-full">
                  {dat.experience}
